...
`,
		...
		"phase4_auth_q":               "%s 将如何登录 Claude？",
		"phase4_auth_token":           "粘贴 setup-token 字符串（claude.ai/setup 上的 sk-ant-oat01-…）",
		"phase4_auth_creds":           "使用已有的 credentials.json",
		"phase4_auth_generate":        "现在生成新的 setup-token（交互，需要浏览器）",
		"phase4_auth_token_q":         "粘贴 setup-token（单行；回车确认）：",
		"phase4_auth_token_empty":     "  (setup-token 为空，重新输入)",
		"phase4_auth_creds_src_q":     "从哪里读取 credentials.json？",
		"phase4_auth_creds_src_file":  "从文件读取",
		"phase4_auth_creds_src_paste": "粘贴文件内容",
		"phase4_auth_creds_path_q":    "credentials.json 文件路径：",
		"phase4_auth_creds_paste_q":   "粘贴 credentials.json 全文（Ctrl+D 提交，Esc 取消）：",
		"phase4_auth_creds_invalid":   "  (无法读取 %s — 重新输入)",
		"phase4_auth_generate_note":   "即将让出终端给 `claude setup-token` …完成后会回到此处。",
		"phase4_auth_installed":       "✓ 凭据已写入 mind-form 卷。",
...
`,
		...
		"phase4_auth_q":               "How will %s log in to Claude?",
		"phase4_auth_token":           "Paste a setup-token string (sk-ant-oat01-... from claude.ai/setup)",
		"phase4_auth_creds":           "Use a pre-generated credentials.json",
		"phase4_auth_generate":        "Generate a fresh setup-token now (interactive, browser needed)",
		"phase4_auth_token_q":         "Paste the setup-token (single line, Enter to confirm):",
		"phase4_auth_token_empty":     "  (setup-token is empty — try again)",
		"phase4_auth_creds_src_q":     "Where will credentials.json come from?",
		"phase4_auth_creds_src_file":  "Read it from a file",
		"phase4_auth_creds_src_paste": "Paste its contents",
		"phase4_auth_creds_path_q":    "Path to credentials.json:",
		"phase4_auth_creds_paste_q":   "Paste the credentials.json body (Ctrl+D to submit · Esc to cancel):",
		"phase4_auth_creds_invalid":   "  (could not read %s — try again)",
		"phase4_auth_generate_note":   "Releasing the terminal to `claude setup-token`... I'll resume after it finishes.",
		"phase4_auth_installed":       "✓ Credentials installed into the mind-form's volume.",
